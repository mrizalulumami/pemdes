<aside class="app-sidebar">
    <ul class="app-menu">
      <li>
        <a class="app-menu__item active" href="<?=base_url('admin');?>"><i class="app-menu__icon fa-solid fa-house"></i><span
            class="app-menu__label">Dashboard</span></a>
      </li>
      <li>
        <a class="app-menu__item" href="<?=base_url('admin/pembayaran');?>"><i class=" app-menu__icon fa-solid fa-credit-card"></i><span
            class="app-menu__label">Pembayaran</span></a>
      </li>
      <li>
        <a class="app-menu__item" href="<?=base_url('admin/data_pelanggan');?>"><i class="app-menu__icon fa-solid fa-user-group"></i><span
            class="app-menu__label">Data
            Pelanggan</span></a>
      </li>
      <li>
        <a class="app-menu__item " href="<?=base_url('admin/pelaporan');?>"><i class="app-menu__icon fa-solid fa-book"></i><span
