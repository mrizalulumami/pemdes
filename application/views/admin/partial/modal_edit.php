        ...
        <div class="mt-3">
            ...
            <div class="form-row">
                ...
                <div class="col">
                    <div class="form-group tb-point">
                        <label><b>RT</b></label>
                        <input type="number" name="rt" value="<?= $a['rt'] ?>" class="form-control" id="rt"
                ...
                <div class="col">
                    <div class="form-group tb-point ml-auto">
                        <label><b>RW</b></label>
                        <input type="number" name="rw" value="<?= $a['rw'] ?>" class="form-control" id="rw"
                            aria-describedby="emailHelp">
                    </div>
                </div>
            </div>
            <div class="form-row">
                ...
                <div class="col">
                    <div class="form-group tb-point ml-auto">
                        ...
                        <input type="text" name="meter_pertama" value="<?= $a['meter_pertama'] ?>" class="form-control"
