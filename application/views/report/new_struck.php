                    ...
                    <table class="mb-2 ml-auto mr-auto mt-2">
                        ...
                        <tbody>
                            <tr class="text-center">
                                <th style="border: 2px solid #000" scope="col"><?= $a['meter_awal'];?></th>
                                <th style="border: 2px solid #000" scope="col"><?= $a['meter_akhir']; ?></th>
                                <th style="border: 2px solid #000" scope="col"><?= $a['pemakaian']; ?></th>
